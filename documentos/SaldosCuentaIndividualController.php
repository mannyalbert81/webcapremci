...
class SaldosCuentaIndividualController extends ControladorBase{
		...
		if (isset(  $_SESSION['nombre_usuarios']) )
		{
			...
			if(isset($_GET["fec"])){
				...
				if($fec=="dic_2017"){
					...
					{
						$nombre_documento="Estados Financieros al 31 de Diciembre del 2017";
						$funcion = "consulta_documentos";
						$parametros = " '$id_usuarios', '$nombre_documento'";
				...
				if($fec=="ene_2018"){
					...
					if(file_exists($mi_pdf))
					{
						$nombre_documento="Estados Financieros al 31 de Enero del 2018";
						$funcion = "consulta_documentos";
						$parametros = " '$id_usuarios', '$nombre_documento'";
						$consulta_documentos->setFuncion($funcion);
						$consulta_documentos->setParametros($parametros);
				...
				if($fec=="fec_2018"){
					...
					if(file_exists($mi_pdf))
					{
						$nombre_documento="Estados Financieros al 28 de Febrero del 2018";
						$funcion = "consulta_documentos";
						$parametros = " '$id_usuarios', '$nombre_documento'";
						$consulta_documentos->setFuncion($funcion);
						$consulta_documentos->setParametros($parametros);
				...
				if($fec=="dic_2014_Informe_Adtitores_Independientes"){
					...
					if(file_exists($mi_pdf))
					{
						...
						$nombre_documento="Informe de los auditores independientes 31-12-2014";
						$funcion = "consulta_documentos";
						$parametros = " '$id_usuarios', '$nombre_documento'";
						$consulta_documentos->setFuncion($funcion);
						$consulta_documentos->setParametros($parametros);
				...
				if($fec=="dic_2014_Informe_Confidencial"){
					...
					if(file_exists($mi_pdf))
					{
						$nombre_documento="Informe Confidencial Sobre la Evaluación del Control Interno 31-12-2014";
						$funcion = "consulta_documentos";
						$parametros = " '$id_usuarios', '$nombre_documento'";
						$consulta_documentos->setFuncion($funcion);
						$consulta_documentos->setParametros($parametros);
				...
				if($fec=="dic_2014_Informe_Procedimientos"){
					...
					if(file_exists($mi_pdf))
					{
						$nombre_documento="Informe de Procedimientos Previamente Convenidos 31-12-2014";
						$funcion = "consulta_documentos";
						$parametros = " '$id_usuarios', '$nombre_documento'";
						$consulta_documentos->setFuncion($funcion);
						$consulta_documentos->setParametros($parametros);
				...
				if($fec=="dic_2014_Informe_Auditoría_Rubro"){
					...
					if(file_exists($mi_pdf))
					{
						$nombre_documento="Informe de Auditoría al Rubro de Inversiones Privativas 31-12-2014";
						$funcion = "consulta_documentos";
						$parametros = " '$id_usuarios', '$nombre_documento'";
						$consulta_documentos->setFuncion($funcion);
						$consulta_documentos->setParametros($parametros);
				...
				if($fec=="dic_2016"){
					...
					$mi_pdf = $directorio.'/documentos/PRESENTACION WEB DIC-2016.pdf';
				
					if(file_exists($mi_pdf))
					{
						$nombre_documento="Presentación Web 31-12-2016";
						$funcion = "consulta_documentos";
						$parametros = " '$id_usuarios', '$nombre_documento'";
						$consulta_documentos->setFuncion($funcion);
						$consulta_documentos->setParametros($parametros);
	...
	if($fec=="2"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/2.pdf';
	...
	if($fec=="2"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/02.pdf';
	...
	if($fec=="3"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/03.pdf';
	...
	if($fec=="51"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/51.pdf';
	...
	if($fec=="52"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/52.pdf';
	...
	if($fec=="6"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/06.pdf';
	...
	if($fec=="7"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/07.pdf';
	...
	if($fec=="8"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/08.pdf';
	...
	if($fec=="9"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/09.pdf';
	...
	if($fec=="10"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/10.pdf';
	...
	if($fec=="11"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/11.pdf';
	...
	if($fec=="121"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/121.pdf';
	...
	if($fec=="122"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/122.pdf';
	...
	if($fec=="14"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/142.pdf';
	...
	if($fec=="171"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/171.pdf';
	...
	if($fec=="172"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/172.pdf';
	...
	if($fec=="173"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/173.pdf';
	...
	if($fec=="174"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/174.pdf';
	...
	if($fec=="175"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/175.pdf';
	...
	if($fec=="176"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/176.pdf';
	...
	if($fec=="177"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/177.pdf';
	...
	if($fec=="178"){
		...
		$mi_pdf = $directorio.'/documentos/ASAMBLEA/178.pdf';
