...
class CategoriasController extends ControladorBase{
	...
	public function ReporteTotal(){
		...
		$columnas = " categorias.nombre_categorias, COUNT(documentos_legal.id_documentos_legal) AS cantidad_documentos, SUM(documentos_legal.paginas_documentos_legal) AS cantidad_paginas ";
		...
		if (isset(  $_SESSION['usuario_usuario']) )
		{
			...
			$this->view("DocumentosxCategorias",array(	"resultSet"=>$resultSet));
