...
public function ReporteTotal(){
		...
		$columnas = " carton_documentos.numero_carton_documentos, COUNT(documentos_legal.id_documentos_legal) AS cantidad_documentos, SUM(documentos_legal.paginas_documentos_legal) AS cantidad_paginas";
		$tablas   = " public.carton_documentos, public.documentos_legal";
		$where    = " documentos_legal.id_carton_documentos = carton_documentos.id_carton_documentos GROUP BY carton_documentos.numero_carton_documentos";
		$id       = " carton_documentos.numero_carton_documentos  ";
		...
		if (isset(  $_SESSION['usuario_usuario']) )
		{
		    ...
		    $this->view("ListadoCartones",array(	"resultSet"=>$resultSet));
