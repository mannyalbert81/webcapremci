...
class SubCategoriasController extends ControladorBase{
	...
	public function ReporteTotal(){
	    ...
	    $columnas = " subcategorias.nombre_subcategorias, COUNT(documentos_legal.id_documentos_legal) AS cantidad_documentos, SUM(documentos_legal.paginas_documentos_legal) AS cantidad_paginas ";
	    $tablas   = " public.categorias, public.subcategorias, public.documentos_legal";
	    $where    = " subcategorias.id_categorias = categorias.id_categorias AND subcategorias.id_subcategorias = documentos_legal.id_subcategorias GROUP BY subcategorias.nombre_subcategorias";
	    ...
	    if (isset(  $_SESSION['usuario_usuario']) )
	    {
	        ...
	        $this->view("DocumentosxSubcategorias",array(	"resultSet"=>$resultSet));
	...
	public function devuelveAllDocumentos()
	{
	    $resultSub = array();
	    ...
	    $resultSub = $subcategorias->getCondiciones($columnas ,$tablas ,$where, $id);
