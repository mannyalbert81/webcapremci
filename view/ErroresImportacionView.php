...
<html lang="es">
      <head>
        <meta charset="utf-8"/>
        <title>Errores de Importación - aDocument 2017</title>
    ...
    <div class="container">
  	...
  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>LISTADO <small>Errores de Importación</small></h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      Aquí puedes encontrar los errores de Importación de archivos del Sistema. Estos pueden ser exportados a las usando los botones que encuntras abajo de este texto. 
                    </p>
