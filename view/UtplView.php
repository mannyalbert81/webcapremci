      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
           <center><img src="img/convenios/utpl.png"  width="100" height="100"></center>
            
            <div class="icon"><i class="ion-ios-analytics-outline"></i></div>
            <h4 class="title"><a href="">Información</a></h4>
           
            <p class="description" align="justify">Ofrece estudios universitarios Modalidad Presencial o a Distancia en todo el territorio Ecuatoriano. <br/>
            Descuentos especiales a los Partícipes del Fondo y sus familiares cercanos dependiendo de la Carrera o Especialidad que elija el Estudiante.<br/><br/>
				<strong>Mayor Información en:</strong><br/><br/>
				<a href="https://www.utpl.edu.ec">www.utpl.edu.ec</a>
					<br/><br/>
						<b></b> Quito – Ecuador
