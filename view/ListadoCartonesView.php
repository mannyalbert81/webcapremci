...
<html lang="es">
      <head>
        <meta charset="utf-8"/>
        <title>Listado de Cartones - aDocument 2017</title>
    ...
    <div class="container">
  	...
  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>LISTADO <small>Cartones Registrados</small></h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      Listado de cartones ingresados al sistema. En la parte inferior encontrarás los controles necesarios para exportar o imprimir esta información. 
                    </p>
