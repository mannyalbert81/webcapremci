...
<html lang="es">
        	   ...
        	   function load_solicitud_prestaciones_registrados(pagina){
                 ...
                 $("#load_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=SolicitudPrestaciones&action=searchadminsuper&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
    ...
    <div class="container">
		...
		<div class="col-md-12 col-lg-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Solicitud<small>de Prestaciones Registradas</small></h2>
                  ...
                  <div class="x_content">
					...
					<input type="text" value="" class="form-control" id="search_solicitud" name="search_solicitud" onkeyup="load_solicitud_prestaciones_registrados(1)" placeholder="search.."/>
					</div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Reasignar Oficial de Prestaciónes</h4>
          </div>
	...
	<script type="text/javascript">
    	...
    	$("#solicitud_prestaciones_registrados").on("click","#btn_abrir",function(event){
    ...
    function cargarUsuarios(){
    	...
    	$("#frm_reasignar").on("submit",function(event){
    		...
    		if($mod_id_nuevo_oficial > 0) {  
	        	...
	        	swal("Alerta!", "Seleccione Oficial Prestaciones", "error")
                return false;
    		...
    		$.ajax({
    			beforeSend:function(){},
    			url:"index.php?controller=SolicitudPrestaciones&action=ReasignarSolicitud",
    			type:"POST",
    			dataType:"json",
    			data:parametros
    			...
    			$div_respuesta.text("Error al reasignar solicitud de prestaciones").addClass("alert alert-warning");
