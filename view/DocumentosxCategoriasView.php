...
<html lang="es">
      <head>
        <meta charset="utf-8"/>
        <title>Documentos por Categorías - aDocument 2017</title>
    ...
    <div class="container">
  	...
  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>LISTADO <small>Documentos por Categorías</small></h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      Listado de documentos ingresados al sistema por Categoría. En la parte inferior encontrarás los controles necesarios para exportar o imprimir esta información. 
                    </p>
