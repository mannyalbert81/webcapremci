...
<html lang="es">
    ...
    <div class="container">
  	...
  	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>INSERTAR<small>Firmas</small></h2>
            ...
            <form  action="<?php echo $helper->url("Firmas","InsertaFirmas"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12 col-md-12 col-xs-12">
