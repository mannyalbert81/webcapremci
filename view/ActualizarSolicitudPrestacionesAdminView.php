    ...
    <div class="container body">
      <div class="main_container">
		...
		<div class="col-md-12 col-lg-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Actualizar<small>Solicitud Prestaciones</small></h2>
          ...
          <form  action="<?php echo $helper->url("SolicitudPrestaciones","ActualizaSolicitudPrestaciones"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12 col-md-12 col-xs-12">
