      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
             ...
             <center><img src="img/convenios/proauto.jpg"  width="100" height="100"></center>
            <div class="icon"><i class="ion-ios-analytics-outline"></i></div>
            <h4 class="title"><a href="">Información</a></h4>
           
            <p class="description" align="justify">Ofrece venta de vehículos nuevos o seminuevos a nivel nacional. Descuentos especiales o bonos a los Partícipes del Fondo y sus familiares cercanos dependiendo del modelo de vehículo que elija el Afiliado al Fondo<br/><br/>
				<strong>Contactos</strong><br/><br/>
					<b></b> Paola Chacón<br/>
					<b>Correo:</b> pchacon@proauto.com.ec<br/>
					<b>Teléfono:</b> 0983356669<br/><br/>
					<b> Ejecutiva de Ventas de Proauto</b><br/>
					<a href="https://proautochevrolet.com.ec">https://proautochevrolet.com.ec</a></b><br/><br/>
					<b></b> Quito – Ecuador
