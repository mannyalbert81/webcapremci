    ...
    <div class="container body">
      <div class="main_container">
		...
		<div class="col-md-12 col-lg-12 col-xs-12">
          ...
          <form  action="<?php echo $helper->url("SolicitudHipotecario","index"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12 col-md-12 col-xs-12">
           
             <div class="col-lg-12 col-md-12 col-xs-12">
             <div class="panel panel-info">
	         <div class="panel-heading">
	         <h4><i class='glyphicon glyphicon-user'></i> Solicitud de Crédito Hipotecario</h4>
	         </div>
			  ...
			  <div class="row">
			           ...
			           <?php if(!empty($error_deudor)) { if($error_deudor=='Permitir'){?>
                         ...
                         <div class="col-lg-12 col-md-12 col-xs-12 " style="text-align: center; margin-top: 30px">
				  		 <a href="index.php?controller=SolicitudHipotecario&action=index&solicitud=d" class="btn btn-success" ><i class="glyphicon glyphicon-edit"></i> Generar</a>
				  		 </div>		
				  		 
				  		 	
                    	<?php }else{?>	
                    	
                    	<p style="text-align: center;"><strong>Estimado participe usted ya cuenta con una solicitud Hipotecaria generada.</strong></p>
