      ...
      <div class="container">
        ...
        <div class="row about-cols">
          ...
          <div class="col-md-3 wow fadeInUp">
            <div class="about-col">
              <div class="img">
                <img src="view/img/about-mission.jpg" alt="" class="img-fluid">
          ...
          <div class="col-md-3 wow fadeInUp" data-wow-delay="0.1s">
            <div class="about-col">
              <div class="img">
                <img src="view/img/about-plan.jpg" alt="" class="img-fluid">
          ...
          <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              <div class="img">
                <img src="view/img/about-vision.jpg" alt="" class="img-fluid">
		...
		<div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              <div class="img">
                <img src="view/img/about15.jpg" alt="" class="img-fluid">
                <div class="icon"><i class="ion-closed-captioning"></i></div>
              </div>
              <h2 class="title"><a href="#">Valores Corporativos</a></h2>
              <p align="justify">
                Ofrecer planes de cesantía de largo plazo, a través del ahorro previsional con una transparente, eficiente y honesta política de inversión de los recursos, tendiente a la entrega ágil y oportuna de una Cesantía acorde a las expectativas del partícipe. El Fondo ofrece créditos quirografarios con tasas y plazos mejores que las del mercado.</p>
            </div>
          </div>
        </div>
    ...
    <section id="service">
      <div class="container">
        ...
        <header class="section-header wow fadeInUp">
          ...
          <p>Saber mas sobre nuestras finanzas nos permite alcanzar más fácilmente nuestras metas.</p>
        </header>
    ...
    <section id="clients" class="wow fadeInUp">
      <div class="container">
        ...
        <div class="owl-carousel clients-carousel">
          <img src="view/img/clients/client-10.png" alt="">
          <img src="view/img/clients/client-11.png" alt="">
          <img src="view/img/clients/client-13.png" alt="">
          <img src="view/img/clients/client-14.png" alt="">
          <img src="view/img/clients/client-16.png" alt="">
		  <img src="view/img/clients/client-17.png" alt="">
		</div>
