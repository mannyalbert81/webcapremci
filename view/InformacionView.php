       ...
       <div class="right_col" role="main">   
        ...
        <div class="col-lg-12 col-md-12 col-xs-12" style="margin-top: 30px;">
            ...
            <div id="dg">
              ...
              <p align="justify"><h5>Aprovecha nuestros convenios, hacercate a una de sus sucursales mas cercana y recibe exelentes descuentos, para poder adquirirlos solo basta con llevar tu cedula de identidad.</h5></p>
