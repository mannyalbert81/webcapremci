...
$image = "";
$conn  = pg_connect("user=postgres port=5432 password=Capremci2018 dbname=web_capremci host=18.218.148.189");
if(!$conn)
{
...
else 
{
		...
		if (!empty($res))
		{
				...
				{
					$archivo=$_SERVER['DOCUMENT_ROOT'].'/template_2018/view/images/'.'nodisponible.jpg';
