        	   ...
        	   function load_cta_individual(pagina){
                 ...
                 $("#load_cta_individual_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=Usuarios&action=consultar_cuenta_individual&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
        	   ...
        	   function load_cta_desembolsar(pagina){
                 ...
                 $("#load_cta_desembolsar_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=Usuarios&action=consultar_cuenta_desembolsar&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
        	   ...
        	   function load_credito_ordinario(pagina){
                 ...
                 $("#load_credito_ordinario_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=Usuarios&action=consultar_credito_ordinario&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
        	   ...
        	   function load_credito_emergente(pagina){
                 ...
                 $("#load_credito_emergente_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=Usuarios&action=consultar_credito_emergente&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
        	   ...
        	   function load_credito_2x1(pagina){
                 ...
                 $("#load_credito_2x1_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=Usuarios&action=consultar_credito_2x1&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
        	   ...
        	   function load_credito_hipotecario(pagina){
                 ...
                 $("#load_credito_hipotecario_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=Usuarios&action=consultar_credito_hipotecario&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
        	   ...
        	   function load_acuerdo_pago(pagina){
                 ...
                 $("#load_acuerdo_pago_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=Usuarios&action=consultar_acuerdo_pago&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
        	   ...
        	   function load_refinanciamiento(pagina){
                 ...
                 $("#load_credito_refinanciamiento_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=Usuarios&action=consultar_credito_refinanciamiento&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
