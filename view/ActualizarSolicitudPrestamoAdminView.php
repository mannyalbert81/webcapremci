      ...
      $("#id_estado_civil_datos_personales").click(function() {
       ...
       <script >
		    ...
		    $("#generar").click(function() 
			{
		    	...
		    	if (plazo_datos_prestamo == 0 || plazo_datos_prestamo == "")
		    	{
    ...
    <div class="container body">
      <div class="main_container">
		...
		<div class="col-md-12 col-lg-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Actualizar<small>Solicitud Préstamo</small></h2>
          ...
          <form  action="<?php echo $helper->url("SolicitudPrestamo","ActualizaSolicitudPrestamo"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12 col-md-12 col-xs-12">
