...
class EntidadBase{
    ...
    public function  EnviarMailSolCredHipotecario($correo_participe, $id_usuario, $_nombres_solicitante_datos_personales, $_apellidos_solicitante_datos_personales){
